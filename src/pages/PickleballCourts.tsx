...
const serviceSchema = {
  ...
  description: "Custom pickleball court design and construction with Laykold surfacing, LED lighting, fencing, and regulation line painting.",
...
const PickleballCourts = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Pickleball Court Builders Augusta & Aiken | CourtPro Augusta"
        description="Expert pickleball court builders in Augusta, GA. Post-tension concrete, cushioned Laykold surfacing, LED lighting, and fencing. 200+ courts delivered. Free estimates: (706) 309-1993."
      />
      ...
      <main>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="group hover:shadow-lg transition-all duration-300 hover:border-primary">
                <CardContent className="p-6 space-y-3">
                  ...
                  <p className="text-muted-foreground leading-relaxed">We use official Laykold® acrylic and cushioned systems—the same surfaces used in major tournaments—to reduce joint strain and ensure consistent ball bounce.</p>
                </CardContent>
              </Card>
              <Card className="group hover:shadow-lg transition-all duration-300 hover:border-primary">
                <CardContent className="p-6 space-y-3">
                  <h3 className="font-bold text-xl text-secondary">Noise Reduction</h3>
                  <p className="text-muted-foreground leading-relaxed">We offer specialized acoustic fencing and surfacing options to keep HOAs and neighbors happy.</p>
                </CardContent>
              </Card>
              <Card className="group hover:shadow-lg transition-all duration-300 hover:border-primary">
                <CardContent className="p-6 space-y-3">
                  <h3 className="font-bold text-xl text-secondary">Lighting & Fencing</h3>
                  <p className="text-muted-foreground leading-relaxed">Complete turnkey installation including black-coated fencing and directed LED lighting for night play.</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24 bg-card">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-black text-secondary mb-12">Construction Options</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="group hover:shadow-lg transition-all duration-300 hover:border-primary">
                <CardContent className="p-6 space-y-3">
                  <h3 className="font-bold text-xl text-secondary">Post-Tension Concrete</h3>
                  <p className="text-muted-foreground leading-relaxed">The gold standard for durability, resisting structural cracking in Georgia's shifting soil.</p>
                </CardContent>
              </Card>
              <Card className="group hover:shadow-lg transition-all duration-300 hover:border-primary">
                <CardContent className="p-6 space-y-3">
                  <h3 className="font-bold text-xl text-secondary">Cushioned Systems</h3>
                  <p className="text-muted-foreground leading-relaxed">Layered rubberized coatings for player comfort and injury prevention.</p>
                </CardContent>
              </Card>
              <Card className="group hover:shadow-lg transition-all duration-300 hover:border-primary">
                <CardContent className="p-6 space-y-3">
                  <h3 className="font-bold text-xl text-secondary">Conversions</h3>
                  <p className="text-muted-foreground leading-relaxed">Expertly resizing and resurfacing unused tennis courts into 2-4 permanent pickleball courts.</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <RelatedServices currentPath="/pickleball-courts" />
        <ContactForm />
      </main>
      <Footer />
      <Chatbot />
