  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.functions.invoke("send-contact-email", {
        body: {
          ...formData,
          number_of_courts: parseInt(formData.number_of_courts, 10) || 1,
        },
      });
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-card">
      <div className="max-w-4xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-black text-secondary mb-2">Get a Free Estimate</h2>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData({
                        ...formData,
                        job_type: value,
                        court_condition: value === "new_build" ? "" : formData.court_condition,
                      })
                    }
                  >
